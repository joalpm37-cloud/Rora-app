...
/**
 * Manejador centralizado de herramientas MCP para GoHighLevel.
 * Mapea los nombres de herramientas definidos para el Agente (Claude/Gemini)
 * a las funciones reales de la API de GHL.
 */
export async function executeGhlTool(name, args) {
    console.log(`🛠️ Ejecutando herramienta GHL: ${name}`, args);
