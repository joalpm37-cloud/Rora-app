      ...
      <div className="glass-card max-w-md w-full p-8 flex flex-col items-center text-center space-y-8">
        <div className="flex flex-col items-center gap-4">
          ...
          <div>
            ...
            <p className="text-obsidian-muted mt-2">Inicia sesión para acceder a tu panel de control</p>
          </div>
        </div>

        <button
          onClick={signInWithGoogle}
          className="w-full bg-white text-black font-medium py-3 px-4 rounded-xl flex items-center justify-center gap-3 hover:bg-gray-100 transition-colors active:scale-95"
        >
